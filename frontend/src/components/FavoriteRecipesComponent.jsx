...
export default function FavoriteRecipesComponent({
  ...
  const recipeListTest = [
    ...
    {
      id: 3,
      name: 'ghjkghjkhgjkghj',
      description: 'ghjkghjkhjkhjgk',
      image: 'hgjkghjkghjk',
      ingredients: ['hjgkhkghjkghj'],
      user: {
        id: 1,
        username: 'asdfasdf',
        pwHash: '$2a$10$IwuQMDcPPFax8MOziGT8IeAExYOI7tgPbpr8ddhPfxwVXiQ00qxVS',
  ...
  return (
    <div className="favoriteRecipes">
      {recipeListTest && recipeListTest.length > 0 ? (
        <div>
          <h2>Favorite Recipes</h2>
          <ul className="favoritesList">
            {recipeListTest.map((recipe, index) => (

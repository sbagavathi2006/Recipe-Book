...
public class AuthenticationController {
    ...
    public String processRegistrationForm(@ModelAttribute @Valid RegisterFormDTO registerFormDTO, Errors errors, HttpServletRequest request, Model model) {
        ...
        if (errors.hasErrors()) {
            model.addAttribute("title", "Register had errors, try again");
            return "register";
        }
        ...
        User newUser = new User(registerFormDTO.getUsername(), registerFormDTO.getPassword(), new ArrayList<>());
    ...
    public String displayLoginForm(Model model) {
        ...
        loginFormDTO.setUsername("TestName");

        model.addAttribute("loginFormDTO", loginFormDTO);
        model.addAttribute("title", "Log In Here");
        return "login";
    }
